    ...
    <div className="flex items-center justify-center w-full mx-4 space-y-2 lg:w-full">
      <div className="w-5/6">
        ...
        <table className="w-full overflow-hidden bg-white border-collapse rounded-lg shadow-md">
            ...
            <tbody>
              {requests.slice(0, visibleRows).map((request, index) => (
                <tr key={request.id} className="border-b hover:bg-red-50">
                  <td className="px-6 py-4 font-medium whitespace-nowrap">{index + 1}</td>
                  <td className="px-6 py-4 font-medium whitespace-nowrap">{request.hospitalName}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{request.wardNo}</td>
                  <td className="px-6 py-4 font-medium whitespace-nowrap">{request.bloodType}</td>
                  ...
                  <td className="p-2 space-x-2">
                    <button
                      onClick={() => alert(`Accepting request ${request.id}`)}
