          ...
          <table className='w-full p-3 border-2 border-red-500 shadow-2xl'>
            ...
            <tbody>
                  ...
                  <td className='px-2 py-2 space-x-2'>
                    <button 
                     onClick={()=>navigate('/Viewcamp')} className="font-bold text-white bg-red-500 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-1 px-4 rounded-xl text-lg"
